...
import { GCRPaperWallet, IAccountInfo, IHDAccountInfo } from 'gcr-paper-wallets';
...
export class ModalBackupProfileTs extends Vue {
    ...
    protected async generateAndDownloadPaperWallet(): Promise<boolean> {
        ...
        const paperWallet = new GCRPaperWallet(rootAccountInfo, this.knownAccountInfos, this.networkType, this.generationHash);
