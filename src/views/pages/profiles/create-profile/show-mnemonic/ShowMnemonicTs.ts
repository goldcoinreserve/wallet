...
import { IHDAccountInfo, GCRPaperWallet } from 'gcr-paper-wallets';
...
export default class ShowMnemonicTs extends Vue {
    ...
    public async downloadPaperWallet() {
        ...
        const paperWallet = new GCRPaperWallet(rootAccountInfo, [], this.currentProfile.networkType, this.currentProfile.generationHash);
