...
export declare abstract class AliasTransaction extends Transaction {
     ...
     */
    static createForMosaic(deadline: Deadline, aliasAction: AliasAction, namespaceId: NamespaceId, mosaicId: MosaicId, networkType: NetworkType, maxFee?: UInt64, signature?: string, signer?: PublicAccount): AliasTransaction;
}
