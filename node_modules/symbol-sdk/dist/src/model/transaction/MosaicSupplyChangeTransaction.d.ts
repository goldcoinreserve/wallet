...
export declare class MosaicSupplyChangeTransaction extends Transaction {
     ...
     */
    static create(deadline: Deadline, mosaicId: UnresolvedMosaicId, action: MosaicSupplyChangeAction, delta: UInt64, networkType: NetworkType, maxFee?: UInt64, signature?: string, signer?: PublicAccount): MosaicSupplyChangeTransaction;
    /**
     * @param networkType
     * @param version
     * @param deadline
