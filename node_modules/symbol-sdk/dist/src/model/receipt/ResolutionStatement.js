...
class ResolutionStatement {
    ...
    generateHash(networkType) {
        ...
        const builder = this.resolutionType === ResolutionType_1.ResolutionType.Address
            ? new catbuffer_typescript_1.AddressResolutionStatementBuilder(ReceiptVersion_1.ReceiptVersion.RESOLUTION_STATEMENT, type.valueOf(), new catbuffer_typescript_1.UnresolvedAddressDto(UnresolvedMapping_1.UnresolvedMapping.toUnresolvedAddressBytes(this.unresolved, networkType)), this.resolutionEntries.map((entry) => new catbuffer_typescript_1.AddressResolutionEntryBuilder(new catbuffer_typescript_1.ReceiptSourceBuilder(entry.source.primaryId, entry.source.secondaryId), entry.resolved.toBuilder())))
            : new catbuffer_typescript_1.MosaicResolutionStatementBuilder(ReceiptVersion_1.ReceiptVersion.RESOLUTION_STATEMENT, type.valueOf(), new catbuffer_typescript_1.UnresolvedMosaicIdDto(UInt64_1.UInt64.fromHex(this.unresolved.toHex()).toDTO()), this.resolutionEntries.map((entry) => new catbuffer_typescript_1.MosaicResolutionEntryBuilder(new catbuffer_typescript_1.ReceiptSourceBuilder(entry.source.primaryId, entry.source.secondaryId), entry.resolved.toBuilder())));
