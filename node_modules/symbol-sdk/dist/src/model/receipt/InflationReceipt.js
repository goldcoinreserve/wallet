...
class InflationReceipt extends Receipt_1.Receipt {
     ...
     */
    serialize() {
        return new catbuffer_typescript_1.InflationReceiptBuilder(ReceiptVersion_1.ReceiptVersion.INFLATION_RECEIPT, this.type.valueOf(), new catbuffer_typescript_1.MosaicBuilder(this.mosaicId.toBuilder(), new catbuffer_typescript_1.AmountDto(this.amount.toDTO()))).serialize();
    }
}
