...
class MosaicRestrictionTransactionService {
    ...
    getAddressRestrictionEntry(mosaicId, restrictionKey, targetAddress) {
        return this.restrictionMosaicRepository.search({ mosaicId, targetAddress }).pipe(operators_1.map((mosaicRestriction) => {
            var _a;
            return (_a = mosaicRestriction.data[0].getRestriction(restrictionKey)) === null || _a === void 0 ? void 0 : _a.restrictionValue;
    ...
    getGlobalRestrictionEntry(mosaicId, restrictionKey) {
        return this.restrictionMosaicRepository.search({ mosaicId }).pipe(operators_1.map((mosaicRestrictionPage) => {
