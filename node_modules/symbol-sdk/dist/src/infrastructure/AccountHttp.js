...
class AccountHttp extends Http_1.Http {
    ...
    static toAccountInfo(dto) {
        var _a, _b, _c, _d;
        return new account_1.AccountInfo(dto.account.version || 1, dto.id, account_1.Address.createFromEncoded(dto.account.address), model_1.UInt64.fromNumericString(dto.account.addressHeight), dto.account.publicKey, model_1.UInt64.fromNumericString(dto.account.publicKeyHeight), dto.account.accountType.valueOf(), new account_1.SupplementalPublicKeys(dto.account.supplementalPublicKeys.linked
