...
class Listener {
     ...
     */
    confirmed(unresolvedAddress, transactionHash) {
     ...
     */
    unconfirmedAdded(unresolvedAddress, transactionHash) {
     ...
     */
    aggregateBondedAdded(unresolvedAddress, transactionHash) {
     ...
     */
    transactionSubscription(channel, unresolvedAddress, transactionHash) {
     ...
     */
    unconfirmedRemoved(unresolvedAddress, transactionHash) {
     ...
     * @return an observable stream of Strings with the transaction hash
     */
    aggregateBondedRemoved(unresolvedAddress, transactionHash) {
     ...
     * @return an observable stream of Strings with the transaction hash
     */
    transactionHashSubscription(channel, unresolvedAddress, transactionHash) {
        return this.getResolvedAddress(unresolvedAddress).pipe(operators_1.mergeMap((address) => {
            this.subscribeTo(`${channel}/${address.plain()}`);
     ...
     */
    cosignatureAdded(unresolvedAddress) {
        return this.getResolvedAddress(unresolvedAddress).pipe(operators_1.mergeMap((address) => {
            this.subscribeTo(`cosignature/${address.plain()}`);
