    ...
    describe('with password -->', function () {
        describe('toJSON() should', function () {
            it('include mandatory NIP-7 QR Code base fields', function () {
                ...
                // Act:
                var exportAccount = new index_1.AccountQR(account.privateKey, symbol_sdk_1.NetworkType.MIJIN_TEST, 'no-chain-id', 'password');
        ...
        describe('fromJSON() should', function () {
            ...
            it('throw error given wrong password', function () {
                // Arrange:
                var account = symbol_sdk_1.Account.createFromPrivateKey('F97AE23C2A28ECEDE6F8D6C447C0A10B55C92DDE9316CCD36C3177B073906978', networkType);
                // Act:
            ...
            it('reconstruct account given correct ciphertext and password', function () {
                ...
                chai_1.expect(symbol_sdk_1.Account.createFromPrivateKey(importAccount.accountPrivateKey, networkType).publicKey).to.be.equal('50BFEB16AA0A3E00B8AB9385A2686991A09522DCDA4AC31B400BB5674EE4CDF8');
            });
        });
    });
    describe('with no password -->', function () {
        describe('toJSON() should', function () {
            it('include mandatory NIP-7 QR Code base fields', function () {
                ...
                var account = symbol_sdk_1.Account.createFromPrivateKey('F97AE23C2A28ECEDE6F8D6C447C0A10B55C92DDE9316CCD36C3177B073906978', symbol_sdk_1.NetworkType.MIJIN_TEST);
                // Act:
                var exportAccount = new index_1.AccountQR(account.privateKey, symbol_sdk_1.NetworkType.MIJIN_TEST, 'no-chain-id');
                var actualJSON = exportAccount.toJSON();
                var actualObject = JSON.parse(actualJSON);
                // Assert:
                chai_1.expect(actualObject).to.have.property('v');
