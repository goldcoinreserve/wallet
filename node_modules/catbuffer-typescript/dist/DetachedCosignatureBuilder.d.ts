...
export declare class DetachedCosignatureBuilder extends CosignatureBuilder implements Serializer {
    ...
    constructor(version: number[], signerPublicKey: KeyDto, signature: SignatureDto, parentHash: Hash256Dto);
    static loadFromBinary(payload: Uint8Array): DetachedCosignatureBuilder;
    static createDetachedCosignatureBuilder(version: number[], signerPublicKey: KeyDto, signature: SignatureDto, parentHash: Hash256Dto): DetachedCosignatureBuilder;
